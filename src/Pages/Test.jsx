  ...
  return (
    <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="transition duration-500 transform hover:scale-105">
          Content
        </div>
            ...
            <div className="overflow-hidden bg-white rounded-md" key={data.id}>
              <div className="px-5 py-6">
                <div className="flex items-center">
                  <img
                    className="flex-shrink-0 object-cover w-100 h-100"
                    src="src/Shared/resources/thumbnail.jpg"
                    alt=""
                  />
                </div>
                <blockquote className="mt-5">
                  <p
                    className={`text-base text-${fontColor}`}
                    style={{
                      maxHeight: "3em",
                      overflow: "hidden",
                      textAlign: "justify",
                  ...
                  <a
                    href={data.path}
                    className={`bg-${buttonBG} hover:bg-blue-600 text-white font-bold py-2 px-4 rounded font-mono`}
                  >
                    View Projects
                  </a>
                </blockquote>
