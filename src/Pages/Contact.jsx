        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div class="max-w-5xl mx-auto mt-12 sm:mt-16">
            <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
              <div class="overflow-hidden bg-white rounded-xl  transition duration-2000 transform hover:scale-110 hover:bg-gray-300">
                <div class="p-6">
                  <svg
              ...
              <div class="overflow-hidden bg-white rounded-xl  transition duration-2000 transform hover:scale-110 hover:bg-gray-300">
                <div class="p-6">
                  ...
                  <p class="mt-6 text-lg font-medium text-gray-900">
                    bryanken01230@gmail.com
                  </p>
                  <p class="mt-1 text-lg font-medium text-gray-900">
                    altes.182794@ortigas-cainta.sti.edu.ph
                  </p>
                </div>
              </div>
